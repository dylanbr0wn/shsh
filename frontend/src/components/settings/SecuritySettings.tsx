    ...
    <FieldSet>
      ...
      <FieldGroup>
        ...
        <Field>
          ...
          <FieldDescription>Lock the vault after this many minutes of inactivity.</FieldDescription>
          <Select value={lockTimeout} onValueChange={handleTimeoutChange} disabled={timeoutLoading}>
